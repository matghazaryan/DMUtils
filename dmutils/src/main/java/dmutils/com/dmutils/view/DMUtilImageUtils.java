...
public final class DMUtilImageUtils {
    ...
    public static int getDrwableByName(Activity pActivity, String pDrwableName) {

        return pActivity.getResources().getIdentifier(pDrwableName, "drawable", pActivity.getPackageName());
    }
